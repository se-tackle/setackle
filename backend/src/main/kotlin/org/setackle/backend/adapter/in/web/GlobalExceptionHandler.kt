package org.setackle.backend.adapter.`in`.web

import org.setackle.backend.adapter.`in`.web.common.ApiResponse
import org.setackle.backend.adapter.`in`.web.common.ErrorResponse
...
class GlobalExceptionHandler {
    ...
    fun handleBusinessException(
        ...
        return ResponseEntity(ApiResponse.error(errorResponse), ex.errorCode.status)
    }
    ...
    fun handleValidationExceptions(
        ...
        return ResponseEntity(ApiResponse.error(errorResponse), errorCode.status)
    }
